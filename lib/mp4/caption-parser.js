...
/**
  ...
  * Assumes that `parseSamples` has been called first.
  *
  * @param {Buffer} avcStream - The bytes of the mdat
...
/**
  ...
  *
  * @param {Array<Buffer>} truns - The Trun Run boxes to be parsed
...
/**
  ...
  *
  * @param {Buffer} segment - The bytes of a single segment
...
/**
  ...
  *
  * @param {Buffer} segment - The fmp4 segment containing embedded captions
