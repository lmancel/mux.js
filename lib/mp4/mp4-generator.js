  ...
  videoSample = function(track) {
    ...
    avc1Box = [
      ...
      box(types.avcC, new Uint8Array([
        ...
        track.levelIdc, // AVCLevelIndication ///// TODO: BUILD CODEC WITH `${track.profileIdc}${track.profileCompatibility}${track.levelIdc}`
...
tkhd = function(track) {
  var result = new Uint8Array([
    ...
    (track.pid & 0xFF000000) >> 24,
    (track.pid & 0xFF0000) >> 16,
    (track.pid & 0xFF00) >> 8,
    track.pid & 0xFF, // track_ID
    0x00, 0x00, 0x00, 0x00, // reserved
